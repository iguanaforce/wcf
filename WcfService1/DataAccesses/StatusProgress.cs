    ...
    public class StatusProgress
    {
        ...
        public List<CustomerDetails> GetAllCustomerDetails()
        {
            ...
            try
            {
                ...
                CustomerDetails = new List<CustomerDetails>();
                {
                    SqlCommand cmd = new SqlCommand("select ESTAR_APPID, TASK_ID, CUSTOMER_NAME, FIELD_NOTE, PRODUCT_TYPE, BRANCH_NAME, DTM_START_SEND, DTM_END_SEND, DTM_APPROVED, SURVEYOR_NAME  from STATUS_PROGRESS2 ", this.connection);
